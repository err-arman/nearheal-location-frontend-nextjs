...
import { MapPin, Phone, Mail, Globe, Map, ExternalLink, ArrowRight } from "lucide-react";
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col mb-10">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
            <h2 className="text-4xl font-bold mb-2">Get Your <span className="text-[#e5b45b] font-serif italic">Free Quote Today!</span></h2>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-12 mb-8">
            {(location.latitude && location.longitude) || location.googleAddress ? (
              <GoogleMap
                pins={[
                  {
                    lat: location.latitude || undefined,
                    lng: location.longitude || undefined,
                    address: !location.latitude || !location.longitude ? location.googleAddress : undefined,
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-gray-200">
                    {location.googleAddress || "4517 Washington Ave.\nManchester, Kentucky 39495"}
                  </p>
                </div>
                ...
                <div>
                  ...
                  {location.phone && (
                    <p className="text-gray-200 mb-1">Phone : {location.phone || "+0123-456-789"}</p>
                  )}
                  {location.email && (
                    <p className="text-gray-200">Email : {location.email || "example@gmail.com"}</p>
                  )}
                </div>
                
                <div>
                  <h3 className="text-xl font-semibold mb-2">Open Time</h3>
                  <p className="text-gray-200 mb-1">Monday - Friday : 10:00 - 20:00</p>
                  <p className="text-gray-200">Saturday - Sunday : 11:00 - 18:00</p>
                </div>
                
                <div>
                  <h3 className="text-xl font-semibold mb-4">Stay Connected</h3>
                  <div className="flex space-x-3">
                    <a href="#" className="bg-[#e5b45b] text-[#2d4c41] p-2 rounded-full hover:bg-[#d4a54a] transition-colors">
