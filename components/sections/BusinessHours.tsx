...
const scheduleHour = [
  { day: "Monday", openTime: "09:00", closeTime: "05:00", isClosed: false },
  { day: "Tuesday", openTime: "09:00", closeTime: "05:00", isClosed: false },
  { day: "Wednesday", openTime: "09:00", closeTime: "05:00", isClosed: false },
  { day: "Thursday", openTime: "09:00", closeTime: "05:00", isClosed: false },
  { day: "Friday", openTime: "09:00", closeTime: "05:00", isClosed: false },
  { day: "Saturday", openTime: "09:00", closeTime: "05:00", isClosed: true },
  { day: "Sunday", openTime: "09:00", closeTime: "05:00", isClosed: true },
];
...
const BusinessHours: React.FC<BusinessHoursProps> = ({ location }) => {
  ...
  const getBusinessHours = (day: string): BusinessHour | undefined => {
    if (!scheduleHour || !scheduleHour) return undefined;
    // @ts-ignore
    return scheduleHour.find((hours) => hours.day === day);
  };
      ...
      <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
            <div>
              <h2 className="text-4xl font-bold mb-2">
                Our <span className="text-[#2d4c41]">Business Hours</span>
              </h2>
        ...
        <div className="max-w-4xl mx-auto">
                        ...
                        <td className="py-5 px-6">
                          <div className="flex items-center">
                            ...
                            <div>
                              ...
                              {isToday(day) && (
                                <p className="text-[#e5b45b] text-sm font-medium">
                                  Today
                                </p>
                              )}
                            </div>
                      ...
                      <div className="flex items-center">
                        ...
                        <div>
                          <p className="font-medium text-gray-800">
                            {day}{" "}
                            {isToday(day) && (
                              <span className="text-[#e5b45b] ml-1">
                                (Today)
                              </span>
                            )}
                          </p>
          ...
          <div className="mt-8 text-center text-gray-600 max-w-2xl mx-auto">
            <p>
              Need assistance outside business hours? Leave a message through
              our contact form and we'll get back to you as soon as possible on
